  ...
  const endpoints = [
    {
      ...
      routes: [
        ...
        {
          method: 'POST',
          path: '/api/players/:uuid/punishments',
    ...
    },
    {
      ...
      routes: [
        ...
        {
          method: 'GET',
          path: '/api/appeals/punishment/:id',
